...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 29 20:02:44 2022

@author: john

Tested in both IBM Dev Skills Network
and in Spyder 5.1.5, part of Anaconda

Note:  You might have to install dash and other modules
...
def get_scatter(value1,value2):
    ...
    if value1 == 'All Sites':
        ...
        filtered_df2_more = filtered_df2[filtered_df2['Launch Site'] == value1]
        fig = px.scatter(filtered_df2_more, x = "Payload Mass (kg)", y = "class", color = "Booster Version Category",\
